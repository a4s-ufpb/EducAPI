...
public class ContextBuilder {
    ...
    public Optional<Context> buildOptionalContext(){
        return Optional.ofNullable(new Context(this.id, this.name, this.imageUrl, this.soundUrl, this.videoUrl));
    }

    public ContextRegisterDTO buildContextRegisterDTO(){
        return new ContextRegisterDTO(this.name, this.imageUrl, this.soundUrl, this.videoUrl);
    }
